...
export function ForSchools({ onRegister }) {
  return (
    <section id="schools" data-testid={BENTO.section} className="relative py-32 md:py-40 bg-[#FEF1F8]">
      <div className="titli-container">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
          ...
          <TitliButton size="lg" onClick={onRegister}>Register your school →</TitliButton>
        </div>

        <div className="grid grid-cols-12 gap-6 md:gap-8">
          <Card index={0} className="col-span-12 md:col-span-7 min-h-[440px] bg-[#111] text-white">
            ...
            <p className="mt-4 max-w-[400px] text-[15px] text-white/80 leading-[1.65]">
                Track how many students launched, how much has been raised, who to
                thank. Export tax-exempt receipts in one click.
              </p>
            </div>
          </Card>
            ...
            <div className="p-8 md:p-10 h-full flex flex-col justify-between">
              <div>
                ...
                <p className="mt-4 text-[15px] text-[#4A4A4A] leading-[1.65] font-body">
                  ...
                  Titli's field work. Platform costs are underwritten by our
                  founding donors.
                </p>
              </div>
              <div className="mt-8 font-sans font-extrabold text-[72px] leading-none text-[#EC5A99]">
                ₹0<span className="text-[24px] text-black/40 font-semibold">/year</span>
              </div>
            </div>
          </Card>
          ...
          <Card index={4} className="col-span-12 md:col-span-4 min-h-[320px] bg-white">
