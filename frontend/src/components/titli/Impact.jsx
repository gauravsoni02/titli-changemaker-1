              ...
              <div className="grid grid-cols-5 items-center">
                <div className="col-span-2 relative aspect-square overflow-hidden">
                  <img
                    src={s.img}
                    alt=""
                    className="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-900 group-hover:scale-105"
                  />
                </div>
                ...
                <div className="col-span-3 p-8 md:p-10">
                  ...
                  <div className="mt-4 text-[15px] font-bold text-[#111]">
                    {s.label}
                  </div>
